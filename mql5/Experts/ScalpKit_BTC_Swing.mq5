//+------------------------------------------------------------------+
//|   ScalpKit BTC/USD — SWING (M15-D1, o'zini sozlaydi)
//|
//|   Bitcoin — 24/7, yuqori volatilitet, kuchli trend portlashlari
...
#property description "ScalpKit BTC/USD — SWING (M15-D1, o'zini sozlaydi)"
...
input group "=== Texnik ==="
input long    InpMagicBase            = 20261100; // Magic asosi (+strategiya, +TF)
...
//+------------------------------------------------------------------+
//--- 15M / donchian_breakout: stop >= 0.260 %, ushlash ~0.18 kun
void Apply_15M_1()
{
   g_cfg.MinAtrPct            = 0.00346;
   g_cfg.MaxAtrPct            = 0.02076;
   g_cfg.AdxMin               = 20.0;
   g_cfg.RequireHTF           = false;
   g_cfg.UseSession           = true;
   g_cfg.SessionStartUTC      = 6;
   g_cfg.SessionEndUTC        = 22;
   g_cfg.TrendLen             = 200;
   ...
   g_cfg.MinSlAtr             = 1.5;
   g_cfg.MaxSlAtr             = 3.5;
   g_cfg.MinStopPct           = 0.002595;
   g_cfg.MaxStopPct           = 0.0346;
   g_cfg.Tp1R                 = 0.0;
...
//--- 1H / donchian_breakout: stop >= 0.525 %, ushlash ~0.73 kun
void Apply_1H_1()
{
   g_cfg.MinAtrPct            = 0.007;
   g_cfg.MaxAtrPct            = 0.042;
   g_cfg.AdxMin               = 20.0;
   g_cfg.RequireHTF           = false;
   g_cfg.UseSession           = true;
   g_cfg.SessionStartUTC      = 6;
   ...
   g_cfg.MinSlAtr             = 1.5;
   g_cfg.MaxSlAtr             = 3.5;
   g_cfg.MinStopPct           = 0.00525;
   g_cfg.MaxStopPct           = 0.07;
   g_cfg.Tp1R                 = 0.0;
   g_cfg.Tp1Fraction          = 0.0;
   g_cfg.Tp2R                 = 0.0;
   g_cfg.Tp1StopToR           = 0.0;
...
//--- 4H / donchian_breakout: stop >= 1.080 %, ushlash ~2.92 kun
void Apply_4H_1()
{
   g_cfg.MinAtrPct            = 0.0144;
   g_cfg.MaxAtrPct            = 0.0864;
   g_cfg.AdxMin               = 20.0;
   g_cfg.RequireHTF           = false;
   ...
   g_cfg.MinSlAtr             = 1.5;
   g_cfg.MaxSlAtr             = 3.5;
   g_cfg.MinStopPct           = 0.0108;
   g_cfg.MaxStopPct           = 0.144;
   g_cfg.Tp1R                 = 0.0;
   g_cfg.Tp1Fraction          = 0.0;
   g_cfg.Tp2R                 = 0.0;
   g_cfg.Tp1StopToR           = 0.0;
...
//--- 1D / donchian_breakout: stop >= 2.835 %, ushlash ~17.50 kun
void Apply_1D_1()
{
   g_cfg.MinAtrPct            = 0.0378;
   g_cfg.MaxAtrPct            = 0.2268;
   g_cfg.AdxMin               = 20.0;
   g_cfg.RequireHTF           = false;
   g_cfg.UseSession           = false;
   g_cfg.SessionStartUTC      = 6;
   ...
   g_cfg.MinSlAtr             = 1.5;
   g_cfg.MaxSlAtr             = 3.5;
   g_cfg.MinStopPct           = 0.02835;
   g_cfg.MaxStopPct           = 0.378;
   g_cfg.Tp1R                 = 0.0;
   g_cfg.Tp1Fraction          = 0.0;
   g_cfg.Tp2R                 = 0.0;
   g_cfg.Tp1StopToR           = 0.0;
...
//--- 15M / range_reversion: stop >= 0.260 %, ushlash ~0.07 kun
void Apply_15M_2()
{
   g_cfg.MinAtrPct            = 0.00346;
   g_cfg.MaxAtrPct            = 0.02076;
...
//--- 1H / range_reversion: stop >= 0.525 %, ushlash ~0.28 kun
void Apply_1H_2()
{
   g_cfg.MinAtrPct            = 0.007;
   g_cfg.MaxAtrPct            = 0.042;
