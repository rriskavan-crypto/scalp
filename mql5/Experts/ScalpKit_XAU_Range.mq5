...
#property description "ScalpKit XAU/USD (oltin) — o'rtachaga qaytish (H1-H4)"
...
input double  InpExpectedHoldDays     = 1.1;  // Kutilgan ushlash (kun)
...
input long    InpMagic                = 20260910; // Magic raqam
